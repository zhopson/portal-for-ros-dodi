                ...
                <div class="panel-body">
                    ...
                    <div class="form-group" style="margin-top:10px">
                        <div class="row">
                            ...
                            <div class="pull-right"><a style="margin:20px 20px 60px 30px"  href="{{  route('clients.new',['usr_id' => $user->id]) }}" role="button" class="btn btn-info"><span class="glyphicon glyphicon-floppy-save" aria-hidden="true"></span>  Добавить информацию</a></div>
                        </div>
                        <div class="col-sm-10 col-sm-offset-1">
                            <p class="bg-warning">
                                <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>
                                Персональные данные пользователя также можно добавить в Разделе 
                                <span class="label label-info">Техподдержка</span> <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span> <span class="label label-info">Пользователи</span>
                            </p>
                        </div>
