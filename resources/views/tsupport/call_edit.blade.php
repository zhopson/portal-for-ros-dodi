...
<div class="container-fluid" style="margin:0 30px 0 30px">
    <form method="POST" action="{{ route('calls.update', ['id' => $cal->id]) }}">
    {{ csrf_field() }}
    <div class="row">
        <div class="col-md-3"><h3 style="margin-top:25px"><div class="header-text">Редактировать звонок</div></h3></div>
    </div>
        <div class="col-md-6">
...
<!--                            <div class="pull-right">Статус</div>-->
                        ...
                        <div class="col-md-5">
                            <div class="checkbox">
                                <label for="id_call_edit_status" >
                                    @if ($cal->status == 'SUCCESS')
                                        <input type="checkbox" id="id_call_edit_status" name="v_call_edit_status" checked>
                                    @else
                                        <input type="checkbox" id="id_call_edit_status" name="v_call_edit_status" >
                                    @endif
                                    Дозвонился
                                </label>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="id_call_edit_abon" name="v_call_edit_abon">
                        </div>
                    </div>
                    </div>                    
                    <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9"> 
                            <textarea rows="6" cols="50" class="form-control" id="id_call_edit_comment" name="v_call_edit_comment" required ></textarea>
                        </div>
                    </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2 col-md-offset-8">
                            <button type="submit" class="btn btn-primary" id="id_call_edit_btn_save">Сохранить</button>
                        </div>
                        <div class="col-md-2">
                            <a class="btn btn-default" href="{{ url()->previous() }}" role="button" id="id_call_edit_btn_cancel">Отмена</a>
                        </div>
                    </div>
                </div>
            </div>
