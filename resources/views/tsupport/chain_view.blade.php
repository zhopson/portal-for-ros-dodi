    ...
    <div class="panel-body">
        <div class="container-fluid">
            ...
            <div class="row" style="margin-top:15px" >
                ...
                @else
                    <div class="col-md-1">
                        <a href="{{ route('notes.new', ['id' => $chain->client_id, 'ch_id' => $id]) }}"><h6><span class="glyphicon glyphicon-paperclip" aria-hidden="true"></span> Заметка</h6></a>
                    </div>
                    @if ( !Auth::user()->hasRole('Учителя') && !Auth::user()->hasRole('Ученики') )
                    <div class="col-md-1">
                        <a href="{{ route('tasks.new', ['id' => $chain->client_id, 'ch_id' => $id]) }}"><h6><span class="glyphicon glyphicon-tasks" aria-hidden="true"></span> Задача</h6></a>
                    </div>
                    <div class="col-md-1">
                        <a href="{{ route('calls.new', ['id' => $chain->client_id, 'ch_id' => $id]) }}"><h6><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span> Звонок</h6></a>
                    </div>
                    @endif
                    <div class="col-md-2">
                        <a href="{{ route('requests.new', ['id' => $chain->client_id, 'ch_id' => $id]) }}"><h6><span class="glyphicon glyphicon-wrench" aria-hidden="true"></span> Обращение</h6></a>
                    </div>
