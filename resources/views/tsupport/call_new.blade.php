...
<div class="container-fluid" style="margin:0 30px 0 30px">
    <form method="POST" action="{{ route('calls.store', ['id' => $client->id]) }}">
    {{ csrf_field() }}
    <div class="row">
        <div class="col-md-3"><h3 style="margin-top:25px"><div class="header-text">Новый звонок</div></h3></div>
    </div>
        <div class="col-md-6">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <select class="form-control" id="id_call_new_category" name="v_call_new_category" required >
                                <option ></option>
...
<!--                            <div class="pull-right">Статус</div>-->
                        ...
                        <div class="col-md-5">
                            <div class="checkbox">
                                <label for="id_call_new_status" >
                                    <input type="checkbox" id="id_call_new_status" name="v_call_new_status" checked>
                                    Дозвонился
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="pull-right">Абонент</div>
                        </div>
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="id_call_new_abon" name="v_call_new_abon">
                        </div>
                    </div>
                    </div>
                    <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9"> 
                            <textarea rows="6" cols="50" class="form-control" id="id_call_new_comment" name="v_call_new_comment" required ></textarea>
                        </div>
                    </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-2 col-md-offset-8">
                    <button type="submit" class="btn btn-primary" id="id_call_new_btn_save">Сохранить</button>
                </div>
                <div class="col-md-2">
                    <a class="btn btn-default" href="{{ url()->previous() }}" role="button" id="id_call_new_btn_cancel">Отмена</a>
                </div>
            </div>
        </div>
    </form>
...
$(document).ready(function () {
    ...
    $('#id_call_new_open_chains').change(function () {
        if ( $('#id_call_new_open_chains').val() === "0" ) {
            ...
            $("#id_call_new_category").prop("required", true);
        }
        else {
            $('#id_call_new_category_section').css('display', 'none');
            $("#id_call_new_category").prop("required", false);
        }
