...
<div class="container-fluid" style="margin:0 15px 0 15px">
    <div class="row">
        <div class="col-md-3"><h3 style="margin-top:25px"><div class="header-text">Обращения</div></h3></div>
    </div>
...
<!--            <div class="row">
            ...
            <div class="table-responsive">
                <table class="display" id="id_reqs_td"  cellspacing="0" width="100%">
